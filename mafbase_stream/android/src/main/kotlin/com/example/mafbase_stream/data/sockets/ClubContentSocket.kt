...
/**
 * Подписка на clubSeatingContent через websocket. Кодовый аналог Dart-класса
 ...
 */
internal class ClubContentSocket(
    clubId: Int,
    table: Int,
) {
    private val url = "wss://mafbase.ru/api/clubSeatingContent?table=$table&clubId=$clubId"
    ...
    companion object {
        private const val TAG = "ClubSocket"

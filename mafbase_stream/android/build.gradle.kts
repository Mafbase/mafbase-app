...
android {
    ...
    defaultConfig {
        ...
        // Protobuf-javalite читает поля reflection'ом по имени `<field>_`.
        // Без этих consumer-rules R8 в release-сборке хост-приложения переименует
        // поля и в runtime сыплется "Field roles_ for X1.d not found".

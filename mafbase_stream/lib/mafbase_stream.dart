...
class MafbaseStream {
  ...
  Future<void> openStreamScreen({
    ...
    /// Длина сегмента записи в минутах. null — платформенный дефолт
    /// (iOS: 40 минут, Android: выключено). 0 — сегментация выключена.
    /// Положительное число — длина сегмента в минутах для обеих платформ.

...
final $typed_data.Uint8List waitForPaymentStatusDescriptor = $convert.base64Decode(
    'ChRXYWl0Rm9yUGF5bWVudFN0YXR1cxILCgdwZW5kaW5nEAASDQoJc3VjY2VlZGVkEAESDAoIY2'
    'FuY2VsZWQQAg==');
...
final $typed_data.Uint8List clubDescriptor = $convert.base64Decode(
    ...
    'RjaXR5iAEBEiEKCWJpbGxlZEZvchgHIAEoCUgEUgliaWxsZWRGb3KIAQESJwoMcGhvdG9UaGVt'
    'ZUlkGAggASgFSAVSDHBob3RvVGhlbWVJZIgBAUIOCgxfZGVzY3JpcHRpb25CCwoJX2ltYWdlVX'
    'JsQgwKCl9ncm91cExpbmtCBwoFX2NpdHlCDAoKX2JpbGxlZEZvckIPCg1fcGhvdG9UaGVtZUlk');
  ...
  '2': [
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.generated.CustomColumnDefinition',
      '10': 'columns'
    },
  ],
};
  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 14,
      '6': '.generated.WaitForPaymentStatus',
      '10': 'status'
    },
  ],
};
...
final $typed_data.Uint8List waitForPaymentResponseDescriptor =
    $convert.base64Decode(
        'ChZXYWl0Rm9yUGF5bWVudFJlc3BvbnNlEjcKBnN0YXR1cxgBIAEoDjIfLmdlbmVyYXRlZC5XYW'
...
const FantasyRatingRow$json = {
  ...
  '2': [
    {'1': 'nickname', '3': 1, '4': 1, '5': 9, '10': 'nickname'},
    {
      ...
      '4': 3,
      '5': 11,
      '6': '.generated.FantasyPredictionItem',
      '10': 'predictions'
    },
...
final $typed_data.Uint8List authEventOutDescriptor = $convert
    .base64Decode('CgxBdXRoRXZlbnRPdXQSFgoGdXNlcklkGAEgASgFUgZ1c2VySWQ=');
  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 14,
      '6': '.generated.ForgotPasswordEventOut.Error',
      '10': 'error'
    },
  ],
  ...
  '2': [
    {
      ...
      '4': 1,
      '5': 14,
      '6': '.generated.ResetPasswordEventOut.Error',
      '10': 'error'
    },
  ],
...
final $typed_data.Uint8List createPhotoThemeEventOutDescriptor = $convert
    .base64Decode('ChhDcmVhdGVQaG90b1RoZW1lRXZlbnRPdXQSDgoCaWQYASABKAVSAmlk');
...
@$core.Deprecated('Use setClubPhotoThemeEventDescriptor instead')
const SetClubPhotoThemeEvent$json = {
  '1': 'SetClubPhotoThemeEvent',
  '2': [
    {
      '1': 'themeId',
      '3': 1,
...
/// Descriptor for `SetClubPhotoThemeEvent`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List setClubPhotoThemeEventDescriptor =
    $convert.base64Decode(
        'ChZTZXRDbHViUGhvdG9UaGVtZUV2ZW50Eh0KB3RoZW1lSWQYASABKAVIAFIHdGhlbWVJZIgBAU'
        'IKCghfdGhlbWVJZA==');
...
final $typed_data.Uint8List clubSeatingContentDescriptor = $convert.base64Decode(
    'ChJDbHViU2VhdGluZ0NvbnRlbnQSKwoFcm9sZXMYASADKA4yFS5nZW5lcmF0ZWQuUGxheWVyUm'
...
final $typed_data.Uint8List changeClubSeatingContentDescriptor = $convert.base64Decode(
    'ChhDaGFuZ2VDbHViU2VhdGluZ0NvbnRlbnQSGwoGcGxheWVyGAEgASgFSABSBnBsYXllcogBAR'

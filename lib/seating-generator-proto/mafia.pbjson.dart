...
@$core.Deprecated('Use getStreamsEventOutDescriptor instead')
const GetStreamsEventOut$json = {
  '1': 'GetStreamsEventOut',
  '2': [
    {'1': 'streams', '3': 1, '4': 3, '5': 11, '6': '.generated.GameStream', '10': 'streams'},
  ],
};

/// Descriptor for `GetStreamsEventOut`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getStreamsEventOutDescriptor =
    $convert.base64Decode('ChJHZXRTdHJlYW1zRXZlbnRPdXQSLwoHc3RyZWFtcxgBIAMoCzIVLmdlbmVyYXRlZC5HYW1lU3'
        'RyZWFtUgdzdHJlYW1z');

@$core.Deprecated('Use getStreamsAdminEventOutDescriptor instead')
const GetStreamsAdminEventOut$json = {
  '1': 'GetStreamsAdminEventOut',
  '2': [
    {'1': 'streams', '3': 1, '4': 3, '5': 11, '6': '.generated.GameStreamAdmin', '10': 'streams'},
  ],
};

/// Descriptor for `GetStreamsAdminEventOut`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getStreamsAdminEventOutDescriptor =
    $convert.base64Decode('ChdHZXRTdHJlYW1zQWRtaW5FdmVudE91dBI0CgdzdHJlYW1zGAEgAygLMhouZ2VuZXJhdGVkLk'
        'dhbWVTdHJlYW1BZG1pblIHc3RyZWFtcw==');
...
@$core.Deprecated('Use generateStreamEventDescriptor instead')
const GenerateStreamEvent$json = {
  '1': 'GenerateStreamEvent',
  '2': [
    {'1': 'tableNumber', '3': 1, '4': 1, '5': 5, '10': 'tableNumber'},
  ],
};

/// Descriptor for `GenerateStreamEvent`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List generateStreamEventDescriptor =
    $convert.base64Decode('ChNHZW5lcmF0ZVN0cmVhbUV2ZW50EiAKC3RhYmxlTnVtYmVyGAEgASgFUgt0YWJsZU51bWJlcg'
        '==');

...
@$core.Deprecated('Use waitForPaymentStatusDescriptor instead')
const WaitForPaymentStatus$json = {
  '1': 'WaitForPaymentStatus',
  '2': [
    {'1': 'pending', '2': 0},
    {'1': 'succeeded', '2': 1},
    {'1': 'canceled', '2': 2},
...
/// Descriptor for `WaitForPaymentStatus`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List waitForPaymentStatusDescriptor =
    $convert.base64Decode('ChRXYWl0Rm9yUGF5bWVudFN0YXR1cxILCgdwZW5kaW5nEAASDQoJc3VjY2VlZGVkEAESDAoIY2'
        'FuY2VsZWQQAg==');
...
final $typed_data.Uint8List ratingSchemeDescriptor =
    $convert.base64Decode('CgxSYXRpbmdTY2hlbWUSCgoGb2xkRlNNEAASDAoIbWludXNGU00QARIQCgxtZWRpYWdhbWVNU0'
        'wQAg==');
...
final $typed_data.Uint8List broadcastPhaseDescriptor =
    $convert.base64Decode('Cg5Ccm9hZGNhc3RQaGFzZRIHCgNkYXkQABIJCgVuaWdodBABEg8KC2JyZWFrX3BoYXNlEAI=');
...
const TableSeating$json = {
  ...
  '2': [
    ...
    {'1': 'players', '3': 4, '4': 3, '5': 11, '6': '.generated.Player', '10': 'players'},
    {'1': 'refereeModel', '3': 5, '4': 1, '5': 11, '6': '.generated.Player', '9': 1, '10': 'refereeModel', '17': true},
  ],
  '8': [
    {'1': '_referee'},
    {'1': '_refereeModel'},
...
final $typed_data.Uint8List editSeatingEventDescriptor =
    $convert.base64Decode('ChBFZGl0U2VhdGluZ0V2ZW50EhIKBGdhbWUYASABKAVSBGdhbWUSFAoFdGFibGUYAiABKAVSBX'
...
const ChangeSeatingContent$json = {
  ...
  '2': [
    ...
    {'1': 'soundEnabled', '3': 7, '4': 1, '5': 8, '9': 6, '10': 'soundEnabled', '17': true},
  ],
  '8': [
    {'1': '_player'},
    {'1': '_imageUrl'},
...
const ClubRatingEventOut$json = {
  ...
  '2': [
    ...
    {'1': 'dateStart', '3': 6, '4': 1, '5': 9, '9': 0, '10': 'dateStart', '17': true},
    {'1': 'dateEnd', '3': 7, '4': 1, '5': 9, '9': 1, '10': 'dateEnd', '17': true},
  ],
  '8': [
    {'1': '_dateStart'},
    {'1': '_dateEnd'},
...
const ClubDefaultRatingPeriod$json = {
  ...
  '2': [
    {'1': 'dateStart', '3': 1, '4': 1, '5': 9, '9': 0, '10': 'dateStart', '17': true},
    {'1': 'dateEnd', '3': 2, '4': 1, '5': 9, '9': 1, '10': 'dateEnd', '17': true},
  ],
  '8': [
    {'1': '_dateStart'},
    {'1': '_dateEnd'},
...
final $typed_data.Uint8List clubDefaultRatingPeriodDescriptor =
    $convert.base64Decode('ChdDbHViRGVmYXVsdFJhdGluZ1BlcmlvZBIhCglkYXRlU3RhcnQYASABKAlIAFIJZGF0ZVN0YX'
...
const SeatingContent$json = {
  ...
  '2': [
    ...
    {'1': 'broadcastPhase', '3': 7, '4': 1, '5': 14, '6': '.generated.BroadcastPhase', '10': 'broadcastPhase'},
...
const BillTournamentEventOut$json = {
  ...
  '2': [
    ...
    {'1': 'purchaseId', '3': 2, '4': 1, '5': 5, '10': 'purchaseId'},
  ],
};
...
final $typed_data.Uint8List billTournamentEventOutDescriptor =
    $convert.base64Decode('ChZCaWxsVG91cm5hbWVudEV2ZW50T3V0EiIKDHJlZGlyZWN0TGluaxgBIAEoCVIMcmVkaXJlY3'
        'RMaW5rEh4KCnB1cmNoYXNlSWQYAiABKAVSCnB1cmNoYXNlSWQ=');

@$core.Deprecated('Use waitForPaymentResponseDescriptor instead')
const WaitForPaymentResponse$json = {
  '1': 'WaitForPaymentResponse',
  '2': [
    {'1': 'status', '3': 1, '4': 1, '5': 14, '6': '.generated.WaitForPaymentStatus', '10': 'status'},
  ],
};

/// Descriptor for `WaitForPaymentResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List waitForPaymentResponseDescriptor =
    $convert.base64Decode('ChZXYWl0Rm9yUGF5bWVudFJlc3BvbnNlEjcKBnN0YXR1cxgBIAEoDjIfLmdlbmVyYXRlZC5XYW'
        'l0Rm9yUGF5bWVudFN0YXR1c1IGc3RhdHVz');
...
const TournamentSubscriptionPlanEventOut$json = {
  ...
  '2': [
    ...
    {'1': 'createdAt', '3': 4, '4': 1, '5': 9, '9': 2, '10': 'createdAt', '17': true},
  ],
  '8': [
    {'1': '_subscriptionType'},
    {'1': '_billedFor'},
...
const TranslationKeyEventOut$json = {
  ...
  '2': [
    ...
    {'1': 'selectedDesignKey', '3': 3, '4': 1, '5': 9, '9': 0, '10': 'selectedDesignKey', '17': true},
  ],
  '8': [
...
final $typed_data.Uint8List bestMoveDistributionDescriptor =
    $convert.base64Decode('ChRCZXN0TW92ZURpc3RyaWJ1dGlvbhISCgRtaXNzGAEgASgFUgRtaXNzEhAKA29uZRgCIAEoBV'
...
const SetTournamentDesignEvent$json = {
  ...
  '2': [
    {'1': 'designKey', '3': 1, '4': 1, '5': 9, '9': 0, '10': 'designKey', '17': true},
  ],
  '8': [
    {'1': '_designKey'},
  ],
...
final $typed_data.Uint8List setTournamentDesignEventDescriptor =
    $convert.base64Decode('ChhTZXRUb3VybmFtZW50RGVzaWduRXZlbnQSIQoJZGVzaWduS2V5GAEgASgJSABSCWRlc2lnbk'
...
const RefereeAssignment$json = {
  ...
  '2': [
    {'1': 'table', '3': 1, '4': 1, '5': 5, '10': 'table'},
    {'1': 'referee', '3': 2, '4': 1, '5': 11, '6': '.generated.Player', '10': 'referee'},
  ],
};

/// Descriptor for `RefereeAssignment`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List refereeAssignmentDescriptor =
    $convert.base64Decode('ChFSZWZlcmVlQXNzaWdubWVudBIUCgV0YWJsZRgBIAEoBVIFdGFibGUSKwoHcmVmZXJlZRgCIA'
...
final $typed_data.Uint8List setRefereeEventDescriptor =
    $convert.base64Decode('Cg9TZXRSZWZlcmVlRXZlbnQSFAoFdGFibGUYASABKAVSBXRhYmxlEisKB3JlZmVyZWUYAiABKA'
...
final $typed_data.Uint8List deleteRefereeEventDescriptor =
    $convert.base64Decode('ChJEZWxldGVSZWZlcmVlRXZlbnQSFAoFdGFibGUYASABKAVSBXRhYmxl');

@$core.Deprecated('Use getRefereesEventOutDescriptor instead')
const GetRefereesEventOut$json = {
  '1': 'GetRefereesEventOut',
  '2': [
    {'1': 'assignments', '3': 1, '4': 3, '5': 11, '6': '.generated.RefereeAssignment', '10': 'assignments'},
  ],
};

/// Descriptor for `GetRefereesEventOut`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getRefereesEventOutDescriptor =
    $convert.base64Decode('ChNHZXRSZWZlcmVlc0V2ZW50T3V0Ej4KC2Fzc2lnbm1lbnRzGAEgAygLMhwuZ2VuZXJhdGVkLl'
...
final $typed_data.Uint8List substitutePlayerEventDescriptor =
    $convert.base64Decode('ChVTdWJzdGl0dXRlUGxheWVyRXZlbnQSIAoLb2xkUGxheWVySWQYASABKAVSC29sZFBsYXllck'
...
const GameStream$json = {
  ...
  '2': [
    ...
    {'1': 'viewerUrl', '3': 3, '4': 1, '5': 9, '9': 0, '10': 'viewerUrl', '17': true},
...
final $typed_data.Uint8List gameStreamDescriptor =
    $convert.base64Decode('CgpHYW1lU3RyZWFtEg4KAmlkGAEgASgFUgJpZBIgCgt0YWJsZU51bWJlchgCIAEoBVILdGFibG'
...
const GameStreamAdmin$json = {
  ...
  '2': [
    ...
    {'1': 'tableNumber', '3': 2, '4': 1, '5': 5, '10': 'tableNumber'},
    {'1': 'viewerUrl', '3': 3, '4': 1, '5': 9, '9': 0, '10': 'viewerUrl', '17': true},
    {'1': 'rtmpServerUrl', '3': 4, '4': 1, '5': 9, '9': 1, '10': 'rtmpServerUrl', '17': true},
    {'1': 'rtmpKey', '3': 5, '4': 1, '5': 9, '9': 2, '10': 'rtmpKey', '17': true},
...
final $typed_data.Uint8List gameStreamAdminDescriptor =
    $convert.base64Decode('Cg9HYW1lU3RyZWFtQWRtaW4SDgoCaWQYASABKAVSAmlkEiAKC3RhYmxlTnVtYmVyGAIgASgFUg'
...
const SetStreamEvent$json = {
  ...
  '2': [
    ...
    {'1': 'viewerUrl', '3': 2, '4': 1, '5': 9, '9': 0, '10': 'viewerUrl', '17': true},
    {'1': 'rtmpServerUrl', '3': 3, '4': 1, '5': 9, '9': 1, '10': 'rtmpServerUrl', '17': true},
    {'1': 'rtmpKey', '3': 4, '4': 1, '5': 9, '9': 2, '10': 'rtmpKey', '17': true},
  ],
  '8': [
    {'1': '_viewerUrl'},
    {'1': '_rtmpServerUrl'},
...
final $typed_data.Uint8List setStreamEventDescriptor =
    $convert.base64Decode('Cg5TZXRTdHJlYW1FdmVudBIgCgt0YWJsZU51bWJlchgBIAEoBVILdGFibGVOdW1iZXISIQoJdm'
...
final $typed_data.Uint8List startVkStreamEventDescriptor =
    $convert.base64Decode('ChJTdGFydFZrU3RyZWFtRXZlbnQSIAoLdGFibGVOdW1iZXIYASABKAVSC3RhYmxlTnVtYmVy');

@$core.Deprecated('Use getStreamsOutDescriptor instead')
const GetStreamsOut$json = {
  '1': 'GetStreamsOut',
  '2': [
    {'1': 'streams', '3': 1, '4': 3, '5': 11, '6': '.generated.GameStream', '10': 'streams'},
  ],
};

/// Descriptor for `GetStreamsOut`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getStreamsOutDescriptor =
    $convert.base64Decode('Cg1HZXRTdHJlYW1zT3V0Ei8KB3N0cmVhbXMYASADKAsyFS5nZW5lcmF0ZWQuR2FtZVN0cmVhbV'
        'IHc3RyZWFtcw==');
...
const GetStreamsAdminOut$json = {
  ...
  '2': [
    {'1': 'streams', '3': 1, '4': 3, '5': 11, '6': '.generated.GameStreamAdmin', '10': 'streams'},
  ],
};

/// Descriptor for `GetStreamsAdminOut`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getStreamsAdminOutDescriptor =
    $convert.base64Decode('ChJHZXRTdHJlYW1zQWRtaW5PdXQSNAoHc3RyZWFtcxgBIAMoCzIaLmdlbmVyYXRlZC5HYW1lU3'
        'RyZWFtQWRtaW5SB3N0cmVhbXM=');

@$core.Deprecated('Use clubSeatingContentDescriptor instead')
const ClubSeatingContent$json = {
  '1': 'ClubSeatingContent',
  '2': [
    {'1': 'roles', '3': 1, '4': 3, '5': 14, '6': '.generated.PlayerRole', '10': 'roles'},
    {'1': 'status', '3': 2, '4': 3, '5': 14, '6': '.generated.PlayerStatus', '10': 'status'},
    {'1': 'images', '3': 3, '4': 3, '5': 9, '10': 'images'},
    {'1': 'names', '3': 4, '4': 3, '5': 9, '10': 'names'},
    {'1': 'broadcastPhase', '3': 5, '4': 1, '5': 14, '6': '.generated.BroadcastPhase', '10': 'broadcastPhase'},
    {'1': 'soundEnabled', '3': 6, '4': 1, '5': 8, '10': 'soundEnabled'},
  ],
};

/// Descriptor for `ClubSeatingContent`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List clubSeatingContentDescriptor =
    $convert.base64Decode('ChJDbHViU2VhdGluZ0NvbnRlbnQSKwoFcm9sZXMYASADKA4yFS5nZW5lcmF0ZWQuUGxheWVyUm'
        '9sZVIFcm9sZXMSLwoGc3RhdHVzGAIgAygOMhcuZ2VuZXJhdGVkLlBsYXllclN0YXR1c1IGc3Rh'
        'dHVzEhYKBmltYWdlcxgDIAMoCVIGaW1hZ2VzEhQKBW5hbWVzGAQgAygJUgVuYW1lcxJBCg5icm'
        '9hZGNhc3RQaGFzZRgFIAEoDjIZLmdlbmVyYXRlZC5Ccm9hZGNhc3RQaGFzZVIOYnJvYWRjYXN0'
        'UGhhc2USIgoMc291bmRFbmFibGVkGAYgASgIUgxzb3VuZEVuYWJsZWQ=');

@$core.Deprecated('Use changeClubSeatingContentDescriptor instead')
const ChangeClubSeatingContent$json = {
  '1': 'ChangeClubSeatingContent',
  '2': [
    {'1': 'player', '3': 1, '4': 1, '5': 5, '9': 0, '10': 'player', '17': true},
    {'1': 'playerId', '3': 2, '4': 1, '5': 5, '9': 1, '10': 'playerId', '17': true},
    {'1': 'role', '3': 3, '4': 1, '5': 14, '6': '.generated.PlayerRole', '9': 2, '10': 'role', '17': true},
    {'1': 'status', '3': 4, '4': 1, '5': 14, '6': '.generated.PlayerStatus', '9': 3, '10': 'status', '17': true},
    {
      '1': 'broadcastPhase',
    ...
    {'1': 'soundEnabled', '3': 6, '4': 1, '5': 8, '9': 5, '10': 'soundEnabled', '17': true},
  ],
  '8': [
    {'1': '_player'},
    {'1': '_playerId'},
...
/// Descriptor for `ChangeClubSeatingContent`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List changeClubSeatingContentDescriptor =
    $convert.base64Decode('ChhDaGFuZ2VDbHViU2VhdGluZ0NvbnRlbnQSGwoGcGxheWVyGAEgASgFSABSBnBsYXllcogBAR'
        'IfCghwbGF5ZXJJZBgCIAEoBUgBUghwbGF5ZXJJZIgBARIuCgRyb2xlGAMgASgOMhUuZ2VuZXJh'
        'dGVkLlBsYXllclJvbGVIAlIEcm9sZYgBARI0CgZzdGF0dXMYBCABKA4yFy5nZW5lcmF0ZWQuUG'
        'xheWVyU3RhdHVzSANSBnN0YXR1c4gBARJGCg5icm9hZGNhc3RQaGFzZRgFIAEoDjIZLmdlbmVy'
        'YXRlZC5Ccm9hZGNhc3RQaGFzZUgEUg5icm9hZGNhc3RQaGFzZYgBARInCgxzb3VuZEVuYWJsZW'
        'QYBiABKAhIBVIMc291bmRFbmFibGVkiAEBQgkKB19wbGF5ZXJCCwoJX3BsYXllcklkQgcKBV9y'
        'b2xlQgkKB19zdGF0dXNCEQoPX2Jyb2FkY2FzdFBoYXNlQg8KDV9zb3VuZEVuYWJsZWQ=');

@$core.Deprecated('Use clubTranslationKeyEventOutDescriptor instead')
const ClubTranslationKeyEventOut$json = {
  '1': 'ClubTranslationKeyEventOut',
  '2': [
    {'1': 'key', '3': 1, '4': 1, '5': 9, '10': 'key'},
  ],
};

/// Descriptor for `ClubTranslationKeyEventOut`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List clubTranslationKeyEventOutDescriptor =
    $convert.base64Decode('ChpDbHViVHJhbnNsYXRpb25LZXlFdmVudE91dBIQCgNrZXkYASABKAlSA2tleQ==');

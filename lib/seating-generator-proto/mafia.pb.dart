...
class BillTournamentEventOut extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(2)
  $core.int get purchaseId => $_getIZ(1);
  @$pb.TagNumber(2)
  set purchaseId($core.int value) => $_setSignedInt32(1, value);
  @$pb.TagNumber(2)
  $core.bool hasPurchaseId() => $_has(1);
  @$pb.TagNumber(2)
  void clearPurchaseId() => $_clearField(2);
}

class WaitForPaymentResponse extends $pb.GeneratedMessage {
  factory WaitForPaymentResponse({
    WaitForPaymentStatus? status,
  }) {
    final result = create();
    if (status != null) result.status = status;
    return result;
  ...
  WaitForPaymentResponse._();

  factory WaitForPaymentResponse.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory WaitForPaymentResponse.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);
  ...
  @$core.pragma('dart2js:noInline')
  static WaitForPaymentResponse create() => WaitForPaymentResponse._();
  @$core.override
  ...
  @$pb.TagNumber(1)
  WaitForPaymentStatus get status => $_getN(0);
  @$pb.TagNumber(1)
  set status(WaitForPaymentStatus value) => $_setField(1, value);
  @$pb.TagNumber(1)
  $core.bool hasStatus() => $_has(0);
  @$pb.TagNumber(1)
  void clearStatus() => $_clearField(1);
...
class GetStreamsEventOut extends $pb.GeneratedMessage {
  factory GetStreamsEventOut({
  ...
  GetStreamsEventOut._();

  factory GetStreamsEventOut.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory GetStreamsEventOut.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetStreamsEventOut',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'generated'), createEmptyInstance: create)
    ..pPM<GameStream>(1, _omitFieldNames ? '' : 'streams', subBuilder: GameStream.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetStreamsEventOut clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetStreamsEventOut copyWith(void Function(GetStreamsEventOut) updates) =>
      super.copyWith((message) => updates(message as GetStreamsEventOut)) as GetStreamsEventOut;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static GetStreamsEventOut create() => GetStreamsEventOut._();
  @$core.override
  GetStreamsEventOut createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static GetStreamsEventOut getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetStreamsEventOut>(create);
  static GetStreamsEventOut? _defaultInstance;

  @$pb.TagNumber(1)
  $pb.PbList<GameStream> get streams => $_getList(0);
}

class GetStreamsAdminEventOut extends $pb.GeneratedMessage {
  factory GetStreamsAdminEventOut({
  ...
  GetStreamsAdminEventOut._();

  factory GetStreamsAdminEventOut.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory GetStreamsAdminEventOut.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GetStreamsAdminEventOut',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'generated'), createEmptyInstance: create)
    ..pPM<GameStreamAdmin>(1, _omitFieldNames ? '' : 'streams', subBuilder: GameStreamAdmin.create)
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetStreamsAdminEventOut clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GetStreamsAdminEventOut copyWith(void Function(GetStreamsAdminEventOut) updates) =>
      super.copyWith((message) => updates(message as GetStreamsAdminEventOut)) as GetStreamsAdminEventOut;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static GetStreamsAdminEventOut create() => GetStreamsAdminEventOut._();
  @$core.override
  GetStreamsAdminEventOut createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static GetStreamsAdminEventOut getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetStreamsAdminEventOut>(create);
  static GetStreamsAdminEventOut? _defaultInstance;
...
class GenerateStreamEvent extends $pb.GeneratedMessage {
  factory GenerateStreamEvent({
    $core.int? tableNumber,
  }) {
    final result = create();
    if (tableNumber != null) result.tableNumber = tableNumber;
  ...
  GenerateStreamEvent._();

  factory GenerateStreamEvent.fromBuffer($core.List<$core.int> data,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(data, registry);
  factory GenerateStreamEvent.fromJson($core.String json,
          [$pb.ExtensionRegistry registry = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(json, registry);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'GenerateStreamEvent',
      package: const $pb.PackageName(_omitMessageNames ? '' : 'generated'), createEmptyInstance: create)
    ..aI(1, _omitFieldNames ? '' : 'tableNumber', protoName: 'tableNumber')
    ..hasRequiredFields = false;

  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GenerateStreamEvent clone() => deepCopy();
  @$core.Deprecated('See https://github.com/google/protobuf.dart/issues/998.')
  GenerateStreamEvent copyWith(void Function(GenerateStreamEvent) updates) =>
      super.copyWith((message) => updates(message as GenerateStreamEvent)) as GenerateStreamEvent;

  @$core.override
  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static GenerateStreamEvent create() => GenerateStreamEvent._();
  @$core.override
  GenerateStreamEvent createEmptyInstance() => create();
  @$core.pragma('dart2js:noInline')
  static GenerateStreamEvent getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GenerateStreamEvent>(create);
  static GenerateStreamEvent? _defaultInstance;

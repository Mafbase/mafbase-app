...
mixin _$ResetPasswordState {
  ...
  ResetPasswordError? get error => throw _privateConstructorUsedError;
...
abstract class $ResetPasswordStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isLoading, ResetPasswordError? error});
}
...
class _$ResetPasswordStateImpl implements _ResetPasswordState {
  _$ResetPasswordStateImpl({this.isLoading = false, this.error});
  ...
  @override
  String toString() {
    return 'ResetPasswordState(isLoading: $isLoading, error: $error)';
  }
...
abstract class _ResetPasswordState implements ResetPasswordState {
  factory _ResetPasswordState(
      {final bool isLoading,
      final ResetPasswordError? error}) = _$ResetPasswordStateImpl;

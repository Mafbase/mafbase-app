...
class OwnersRepositoryImpl extends BaseRepository implements OwnersRepository {
  ...
  @override
  Future<void> addOwner({required int tournamentId, required String email}) async {
    await AddOwnerRequest(tournamentId: tournamentId, email: email).execute(client);
  }

  @override
  Future<void> deleteOwner({required int tournamentId, required int ownerId}) async {

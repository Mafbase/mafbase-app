...
class ClubStreamExpansionTile extends StatelessWidget {
  final int clubId;
...
class _ClubStreamItem extends StatelessWidget {
  final int clubId;
  final int tableNumber;
...
class _OperatorLinkButton extends StatelessWidget {
  ...
  const _OperatorLinkButton({required this.clubId, required this.tableNumber, required this.token});
  ...
  Widget build(BuildContext context) {
    ...
    return Align(
      ...
      child: TextButton.icon(
        onPressed: () async {
          final link = buildBroadcastDeeplink(clubId: clubId, table: tableNumber, token: token);

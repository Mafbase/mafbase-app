...
class PlayerStatisticsRepositoryImpl extends BaseRepository
    implements PlayerStatisticsRepository {
  PlayerStatisticsRepositoryImpl(super.client);

  @override
  Future<PlayerStatisticsModel> getPlayerStatistics(int playerId) async {
    final result =
        await GetPlayerStatisticsRequest(playerId: playerId).execute(client);

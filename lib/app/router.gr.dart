...
/// generated route for
/// [PaymentWaitingPage]
class PaymentWaitingRoute extends PageRouteInfo<PaymentWaitingRouteArgs> {
  PaymentWaitingRoute({
    int? purchaseId,
    String? nextPath,
    Key? key,
    List<PageRouteInfo>? children,
          ...
          PaymentWaitingRoute.name,
          args: PaymentWaitingRouteArgs(
            purchaseId: purchaseId,
            nextPath: nextPath,
            key: key,
          ),
          rawQueryParams: {'purchaseId': purchaseId, 'nextPath': nextPath},
          initialChildren: children,
        );

  static const String name = 'PaymentWaitingRoute';

  static PageInfo page = PageInfo(
    name,
    builder: (data) {
      final queryParams = data.queryParams;
      final args = data.argsAs<PaymentWaitingRouteArgs>(
        orElse: () => PaymentWaitingRouteArgs(
          purchaseId: queryParams.optInt('purchaseId'),
          nextPath: queryParams.optString('nextPath'),
        ),
      );
...
class PaymentWaitingRouteArgs {
  const PaymentWaitingRouteArgs({this.purchaseId, this.nextPath, this.key});
  ...
  @override
  String toString() {
    return 'PaymentWaitingRouteArgs{purchaseId: $purchaseId, nextPath: $nextPath, key: $key}';
  }
  ...
  @override
  int get hashCode => purchaseId.hashCode ^ nextPath.hashCode ^ key.hashCode;
}
...
/// generated route for
/// [StreamsPage]
class StreamsRoute extends PageRouteInfo<StreamsRouteArgs> {
  StreamsRoute({
    Key? key,
    required int tournamentId,
    List<PageRouteInfo>? children,
          ...
          StreamsRoute.name,
          args: StreamsRouteArgs(key: key, tournamentId: tournamentId),
          rawPathParams: {'id': tournamentId},
          initialChildren: children,
        );
  ...
  static PageInfo page = PageInfo(
    ...
    builder: (data) {
      final pathParams = data.inheritedPathParams;
      final args = data.argsAs<StreamsRouteArgs>(
        orElse: () => StreamsRouteArgs(tournamentId: pathParams.getInt('id')),
      );
      return StreamsPage(key: args.key, tournamentId: args.tournamentId);
    },
  );
}

class StreamsRouteArgs {
  const StreamsRouteArgs({this.key, required this.tournamentId});
  ...
  @override
  String toString() {
    return 'StreamsRouteArgs{key: $key, tournamentId: $tournamentId}';
  }

  @override
  bool operator ==(Object other) {
    if (identical(this, other)) return true;
    if (other is! StreamsRouteArgs) return false;
    return key == other.key && tournamentId == other.tournamentId;
  }
